...
class GaussianDiffusion:
    ...
    def training_losses_e2e(self, model, micro, t, model_kwargs=None, noise=None):
        ...
        # th.tensor([0]).to('cuda')
        x_start_mean = (model.model.module.get_embeds if hasattr(model.model, "module") else model.model.get_embeds)(input_ids)
        mix_start_mean = (model.model.module.get_embeds if hasattr(model.model, "module") else model.model.get_embeds)(mix_ids)
        ...
        get_logits = model.model.module.get_logits if hasattr(model.model, "module") else model.model.get_logits
